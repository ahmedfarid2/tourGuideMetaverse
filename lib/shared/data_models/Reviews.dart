...
final List<Review> reviews = [
  Review(
    ...
    rating: 5.0,
    avatarImage: const AssetImage('assets/images/tourguide/guide1.jpg'),
  ),
  Review(
    name: "Emily Smith",
    comment: "Wonderful experience! Highly recommended.",
    rating: 4.5,
    avatarImage: const AssetImage('assets/images/tourguide/guide2.jpg'),
  ),
  Review(
    name: "Michael Johnson",
    comment: "The best place I've ever been to!",
    rating: 5.0,
    avatarImage: const AssetImage('assets/images/tourguide/guide3.jpg'),
  ),
  Review(
    name: "Jessica Anderson",
    comment: "A hidden gem! Loved every moment.",
    rating: 4.0,
    avatarImage: const AssetImage('assets/images/tourguide/guide4.jpg'),
  ),
  Review(
    name: "Matthew Davis",
    comment: "Exceptional service and breathtaking views.",
    rating: 4.5,
    avatarImage: const AssetImage('assets/images/tourguide/guide5.jpg'),
  ),
  Review(
    name: "Olivia Wilson",
    comment: "An unforgettable adventure!",
    rating: 5.0,
    avatarImage: const AssetImage('assets/images/tourguide/guide6.jpg'),
  ),
  Review(
